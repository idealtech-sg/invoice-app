    ...
    filteredData() {
      return this.invoiceData.filter((invoice) => {
        if (this.filteredInvoice === "Draft") {
            ...
            invoice.paymentDueDate.toLowerCase().includes(this.searchQuery.toLowerCase()) ||
            invoice.invoiceId.toLowerCase().includes(this.searchQuery.toLowerCase()) ||
            invoice.invoiceItemList.some((item) => item.itemName.toLowerCase().includes(this.searchQuery.toLowerCase())) ||
            invoice.productDescription.toLowerCase().includes(this.searchQuery.toLowerCase()));            
          } 
            ...
            return (invoice.clientName.toLowerCase().includes(this.searchQuery.toLowerCase()) ||
            invoice.paymentDueDate.toLowerCase().includes(this.searchQuery.toLowerCase()) ||
            invoice.invoiceId.toLowerCase().includes(this.searchQuery.toLowerCase()) ||
            invoice.invoiceItemList.some((item) => item.itemName.toLowerCase().includes(this.searchQuery.toLowerCase())) ||
            invoice.productDescription.toLowerCase().includes(this.searchQuery.toLowerCase()));
